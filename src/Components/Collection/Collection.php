...
class Collection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable, Arrayable, Jsonable
{
    ...
    /**
     * $items是任意可迭代类型的,也包括是Collection自身的实例
    ...
    /**
     * 获取集合中不存在于给定项中的项（返回的还是Collection实例）
     *
     * @param  mixed  $items
     * @return static
     */
    ...
    {
        /**
         * array_diff()注意本函数只检查了多维数组中的一维,一旦传入了多维数组则会报错
         */
    ...
    {
        /**
         * array_diff_key()注意本函数只检查了多维数组中的一维,一旦传入了多维数组则会报错
         */
        return new static(array_diff_key($this->items, $this->getArrayableItems($items)));
    }

    /**
     * 去除指定key的键值对，支持嵌套的key
     *
     * @param  mixed  $keys
     * @return static
     */
    ...
    /**
     * 通过键从集合中移除数据项（返回的是修改后的调用集合，不是新的实例）
     * @param $keys
     * @return $this
     */
    ...
    {
        /**
         * array_slice() 默认会重新排序并重置数组的数字索引。你可以通过将 preserve_keys 设为 TRUE 来改变此行为
         */
